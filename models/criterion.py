...
class SetCriterion(nn.Module):
    ...
    def get_losses(self, outputs, targets, indices):
        ...
        loss_keypoints = F.l1_loss(out_keypoints, target_keypoints, reduction='none')
        loss_objectness = F.binary_cross_entropy_with_logits(out_confidence, target_confidence,
