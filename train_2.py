...
def main(args):
    ...
    criterion = SetCriterion_2(anchor, args.grid_size, device, args.threshold).to(device)
    ...
    for epoch in range(args.epochs):
        ...
        val_stats = evaluate(model=model, data_loader=test_dataloader, anchor=anchor, device=device, threshold=args.threshold,
                             ...
                             save_skeleton=True, save_attention_weight=False)
        # ap = val_stats['AP']
